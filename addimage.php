  ...
  <body>
    ...
    <div id="wrap">
        ...
        <div class="page-header">
			...
			<div class="container">
				<ul class="nav nav-tabs">
					<li><a href="addurl.php">Add Sites</a></li>
					<li class="active"><a href="addimage.php">Add Images</a></li>
				</ul>
			</div>
			<div class="navbar">
	  ...
	  <div class="container well">
		...
		<form class="form-horizontal" method="post" action="addimg.php">
			<div class="control-group">
				<label class="control-label">Site URL</label>
				<div class="controls">
					<input class="input-block-level" type="text" name="siteUrl" placeholder="http:// or https://">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">Images URL</label>
				<div class="controls">
					<input class="input-block-level" type="text" name="imageUrl" placeholder="Title Meta">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">Alternative</label>
				<div class="controls">
					<input class="input-block-level" type="text" name="alt" placeholder="alt">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">Title</label>
				<div class="controls">
					<input class="input-block-level" type="text" name="title" placeholder="Image Title">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<input type="text" name="broken" placeholder="Set value '1' if URL is broken"><span class="help-inline"> Default Value is <b>"0"</b> (Normal URL).</span>
